        ...
        <div class="col-lg-6">
          ...
          <div class="p-4">
            <div class="img text-center">
              <img @if(isset($data_profil->foto_profil)) src="{{ asset('user/'.$data_profil->foto_profil) }}" @else src="{{ asset('user/blank.jpg') }}" @endif class="rounded-circle" alt="Foto Profil" width="300rem" height="300rem">
        ...
        @endif
            <div class="row p-4" style="background:#fafbff;">
              ...
              <div class="col-md-12 mb-4">
                ...
                <input name="nama" type="text" class="form-control" id="nama" value="{{ $data_profil->user->nama ?? $data_user->nama }}">
              </div>
              <div class="col-md-12 mb-4">
...
<script>
  ...
  $(window).on('load', function() {
    ...
    var kecamatan_id = {{ $data_profil->kecamatan_id ?? '0' }};
